...
👉 [**nixup 라이프사이클 자세히 보기**](./lifecycle-nixup.md)
...
👉 [**nixstrap 라이프사이클 자세히 보기**](./lifecycle-nixstrap.md)
...
- 📐 **내부 원리**: [Mods 내부 원리](./mods-internals.md) — 스캐닝 규칙, 경로 자동 유도, enable 계층, autoWrap, Dual-Context
- 📖 **사용법 · API · Cookbook**: [Mod 만들기](../how-to/create-mod.md) · [Mod API](../reference/mod-api.md)
