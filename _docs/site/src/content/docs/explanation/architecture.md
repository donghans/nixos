---
title: "🏗️ 프로젝트 아키텍처 (Internal Components)"
---
...
> 내부 원리 상세: [Mods 내부 원리](./mods-internals)
> 사용법 및 API: [Mod 만들기](../how-to/create-mod) · [Mod API](../reference/mod-api)
