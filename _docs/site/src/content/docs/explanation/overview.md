---
title: "🛠️ 고급 사용자용 기술 가이드 (HACKING)"
---
...
👉 [**nixup 라이프사이클 자세히 보기**](./lifecycle-nixup)
...
👉 [**nixstrap 라이프사이클 자세히 보기**](./lifecycle-nixstrap)
...
- 📐 **내부 원리**: [Mods 내부 원리](./mods-internals) — 스캐닝 규칙, 경로 자동 유도, enable 계층, autoWrap, Dual-Context
- 📖 **사용법 · API · Cookbook**: [Mod 만들기](../how-to/create-mod) · [Mod API](../reference/mod-api)
