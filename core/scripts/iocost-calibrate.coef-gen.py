#!/usr/bin/env python3
#
# Vendored verbatim from the Linux kernel source tree
# (tools/cgroup/iocost_coef_gen.py, torvalds/linux master, fetched 2026-08-04)
# — 이 리포에서 이 파일은 core/scripts/iocost-calibrate.sh가 호출하는 벤더 종속성이다.
# 로직은 수정하지 않았음. 업스트림 업데이트가 필요하면 위 경로에서 다시 받아 교체할 것.
#
