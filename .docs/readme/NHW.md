...
- `nhw check --deep`: 5단계를 `nix flake check`로 교체하여 **전체 호스트**를 완전히 검사합니다. 시간이 오래 걸리지만 CI 수준의 완전한 검증을 제공합니다.
...
- 파일명 형식: `YYYYMMDDTHHMMSS-[target]-[action].log` (예: `20260405T120000-os-switch.log`, ISO는 `20260405T120000-iso-x86_64.log` 또는 `20260405T120000-iso-aarch64.log`)
